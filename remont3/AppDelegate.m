...
- (UIStoryboard *)grabStoryboard {
    ...
    switch (screenHeight) {
        ...
        case 736:
            ...
            // iPhone X
        case 812:
            storyboard = [UIStoryboard storyboardWithName:@"Main-x" bundle:nil];
            break;
            
            // iPad 10.5
        case 1112:
            storyboard = [UIStoryboard storyboardWithName:@"Main-Ipad105" bundle:nil];
            break;
            // iPad 12.9
        case 1366:
            storyboard = [UIStoryboard storyboardWithName:@"Main-Ipad129" bundle:nil];
            break;
...
- (NSPersistentContainer *)persistentContainer {
    ...
    @synchronized (self) {
        if (_persistentContainer == nil) {
            _persistentContainer = [[NSPersistentContainer alloc] initWithName:@"remont3"];
